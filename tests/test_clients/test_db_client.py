...
def test_db_client_initialization(mock_inspect, mock_create_engine):
...
@patch('src.clients.db_client.create_engine')
@patch('src.clients.db_client.inspect')
def test_get_tables(mock_inspect, mock_create_engine):
...
@patch('src.clients.db_client.create_engine')
@patch('src.clients.db_client.inspect')
def test_get_schema(mock_inspect, mock_create_engine):
...
def test_execute_query(mock_text, mock_inspect, mock_create_engine):
