...
def test_jira_client_initialization(mock_jira: MagicMock) -> None:
...
@patch("src.clients.jira_client.JIRA")
def test_get_active_issues(mock_jira: MagicMock) -> None:
...
@patch("src.clients.jira_client.JIRA")
def test_get_issue(mock_jira: MagicMock) -> None:
...
@patch("src.clients.jira_client.JIRA")
def test_get_comments(mock_jira: MagicMock) -> None:
...
@patch("src.clients.jira_client.JIRA")
def test_add_comment(mock_jira: MagicMock) -> None:
...
@patch("src.clients.jira_client.JIRA")
def test_extract_issue_details(mock_jira: MagicMock) -> None:
