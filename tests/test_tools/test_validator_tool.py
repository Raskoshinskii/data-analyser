...
def test_validator_tool_initialization(mock_chat_openai):
...
def test_check_syntax_valid(mock_sqlparse, mock_chat_openai):
...
@patch('src.tools.validator_tool.ChatOpenAI')
@patch('src.tools.validator_tool.sqlparse')
def test_check_syntax_invalid(mock_sqlparse, mock_chat_openai):
...
@patch('src.tools.validator_tool.ChatOpenAI')
def test_check_dangerous_patterns_safe(mock_chat_openai):
...
@patch('src.tools.validator_tool.ChatOpenAI')
def test_check_dangerous_patterns_unsafe(mock_chat_openai):
...
@patch('src.tools.validator_tool.ChatOpenAI')
def test_check_schema_compatibility_valid(mock_chat_openai):
...
def test_check_schema_compatibility_invalid(mock_extract_tables, mock_chat_openai):
    ...
    # Check schema compatibility
    is_compatible, error = tool.check_schema_compatibility("SELECT * FROM nonexistent_table")
...
@patch('src.tools.validator_tool.ChatOpenAI')
def test_validate_sql_all_valid(mock_chat_openai):
...
@patch('src.tools.validator_tool.ChatOpenAI')
def test_validate_sql_with_errors(mock_chat_openai):
