...
class ValidatorTool:
    def __init__(self, llm: Optional[BaseLanguageModel] = None, schema_dict: Optional[dict] = None):
        self.llm = llm
        self.schema_dict = schema_dict
        self.schema_columns = self._get_columns_from_schema(schema_dict) if schema_dict else set()
